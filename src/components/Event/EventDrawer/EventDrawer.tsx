...
const EventModal: FCC<EventModalProps> = ({
  open,
  itemId,
  onClose,
  onComplete,
  ...
  const handleInspectorUpdate = (e: React.FormEvent) => {
    ...
    updateForInspector(
      [
        CHARACTER_EVENT_MODEL.updateForInspectorUrl(itemId as number),
        hrFormData,
      ],
      {
        onSuccess: () => {
  ...
  const handleCharacterUpdate = (e: React.FormEvent) => {
    ...
    updateForCharacter(
      [
        MODEL_CHARACTER_EVENTS.updateForCharacterUrl(itemId as number),
                      ...
                      <div>
                        ...
                        <div className='grid grid-cols-2 gap-2 md:gap-4'>
                          ...
                          <div className='rounded-lg border border-indigo-500/20 bg-slate-800/50 p-3 md:p-4'>
                            ...
                            <p className='text-base font-bold text-white md:text-xl'>
                              {response?.data?.event?.currency?.toLocaleString()}
                            </p>
                          </div>
                        </div>
                      </div>
